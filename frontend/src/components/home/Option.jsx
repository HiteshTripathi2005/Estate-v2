        ...
        >
          <NavLink to="/login">
            <img
              ...
              className="w-full h-[300px] md:h-[400px] object-cover rounded-lg"
            />
            <span className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white transition-all duration-150 cursor-pointer hover:text-slate-200 text-2xl md:text-3xl lg:text-4xl font-bold bg-black/50 p-2 rounded">
              Buy
            </span>
          </NavLink>
        </motion.div>
